...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">GREGARIOUS</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>JOIN GREGARIOUS TODAY.</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<input id="email" type="email" class="form-control" placeholder="abc@gmail.com" name="u_email" required="required">
					</div><br>
					<div class="input-group">
