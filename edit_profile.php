...
<tr>
 ...
 <tr>
   ...
   <td>
    <input class="form-control input-md" type="date"  name="u_gender" required value="<?php echo $user_birthday; ?>"> 
    </td>  
</tr>
...
<td>
<button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">Turn On
</button>
...
<div class="modal-dialog">
 ...
 <div class="modal-header">
     ...
     <form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
         ...
         <textarea class="form-control" cols="83" rows="4" name="content" placeholder="Food"></textarea><br>
