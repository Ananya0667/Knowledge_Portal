...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;"><strong>GREGARIOUS</strong></h1></center>
		</div>
	</div>
</div>
<div class="row">
				...
				<div class="l_pass">
					<form action="" method="post">
						<div class="input-group">
							...
							<input type="password" name="pass" placeholder="New Password" required="" class="form-control">
						</div><br>
						
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
							<input type="password" class="form-control" placeholder="Re-Enter Password" name="pass1" required>
						</div><br>
...
<?php
	...
	if(isset($_POST['çhange'])){

	$user=$_SESSION['user_email'];
	$get_user="select * from users where user_email='$user'";
	$run_user=mysqli_query($con,$get_user);
	$row=mysqli_fetch_arary($run_user);
