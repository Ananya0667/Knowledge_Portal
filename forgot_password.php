				...
				<div class="l_pass">
					<form action="" method="post">
						<div class="input-group">
							...
							<input type="email" name="email" placeholder="Enter your mail" required="" class="form-control">
						</div><br>
						<pre class="text">Enter your friend's name...</pre>
						<div class="input-group">
...
include("includes/connection.php");
	...
	if (isset($_POST['submit'])) {
		...
		if($check_user == 1){
			...
			echo"<script>alert('Your Email or Friends Name is incorrect')</script>";
		}
	}
?>